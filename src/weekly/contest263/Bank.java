...
public class Bank {
    ...
    public boolean transfer(int account1, int account2, long money) {
        if (checkAccount(account1)==false || checkAccount(account2)==false) {
            return false;
        }
